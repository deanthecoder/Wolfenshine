...
- F2 switches live between the authentic software image and an experimental shader-enhanced view with movement bob, dynamic lighting, distance shading, and subtle ambient occlusion around wall edges.
