...
- F2 switches live between authentic movement/software rendering and an experimental enhanced mode with momentum-based movement, view bob and weapon sway, colored directional lighting, muzzle-flash illumination, doorway light spill, selective bloom, generated wall relief with material-specific specular highlights, distance shading and fog, geometry-aware ambient occlusion, room ambience derived from local light coverage, and soft ground shadows beneath enemies.
